...
export async function getUserProfile(
  ...
  try {
    ...
    const parsed = {
      ...baseProfile,
      basic_info:
        parseJSONSafe(baseProfile.basic_info, "getUserProfile basic_info") ||
        {},
      preferences:
        parseJSONSafe(baseProfile.preferences, "getUserProfile preferences") ||
        {},
      physiological:
        parseJSONSafe(
          baseProfile.physiological,
          "getUserProfile physiological",
        ) || {},
      load_anchors: parseLoadAnchors(baseProfile.load_anchors),
      psychological:
        parseJSONSafe(
          baseProfile.psychological,
          "getUserProfile psychological",
        ) || {},
    };
...
export async function deleteLoadAnchor(
  ...
  try {
    ...
    console.log(
      "[UserProfile] Deleting load anchor for user:",
      userId,
      "exercise:",
      exerciseId,
    );
...
export async function updateUserProfile(
  ...
  try {
    ...
    const parsedProfile = {
      ...baseProfile,
      basic_info:
        parseJSONSafe(baseProfile.basic_info, "updateUserProfile basic_info") ||
        {},
      preferences:
        parseJSONSafe(
      ...
      physiological:
        parseJSONSafe(
          baseProfile.physiological,
          "updateUserProfile physiological",
        ) || {},
      load_anchors: parseLoadAnchors(baseProfile.load_anchors),
      psychological:
        parseJSONSafe(
          baseProfile.psychological,
          "updateUserProfile psychological",
        ) || {},
    };
