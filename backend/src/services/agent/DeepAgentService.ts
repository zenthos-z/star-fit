...
const BASE_SYSTEM_PROMPT = [
  ...
  "`type` is EXACTLY one of these SIX values (no others exist — `instruction`,",
  "`plan`, `summary` etc. are NOT valid types and will be rejected):",
  "  survey_card | plan_card | summary_card | deviation_card | audit_complete | profile_update_confirm.",
