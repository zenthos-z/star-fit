...
export const ActionCard: React.FC<ActionCardProps> = ({ exercise, selected, onEdit, onDelete, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      <div className="!aspect-[4/3] w-full bg-gray-100 relative flex-shrink-0 overflow-hidden" style={{ aspectRatio: '4/3' }}>
        ...
        {hasVideo && (
          <div className="absolute top-2 right-2 px-1.5 py-0.5 bg-black/60 backdrop-blur rounded text-[10px] text-white font-medium flex items-center gap-1 z-10">
