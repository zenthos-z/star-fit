...
const config: CapacitorConfig = {
  ...
  includePlugins: ['AppPlugin', 'LiquidGlassPlugin', 'WatchConnectivityPlugin', 'SpeechRecognitionPlugin', '@capacitor/keyboard', '@capacitor/camera', '@capawesome/capacitor-file-picker', '@capacitor/haptics'],
  plugins: {
