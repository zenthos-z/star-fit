...
const config: CapacitorConfig = {
  ...
  // 手写原生插件（iOS: LiquidGlassPlugin.swift / MuscleMapPlugin.swift 等）注册进桥
  includePlugins: ['AppPlugin', 'LiquidGlassPlugin', 'WatchConnectivityPlugin', 'SpeechRecognitionPlugin', 'MuscleMapPlugin', '@capacitor/keyboard', '@capacitor/camera', '@capawesome/capacitor-file-picker', '@capacitor/haptics'],
  plugins: {
